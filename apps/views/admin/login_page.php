...
.button-success:focus, .btn-success.focus {
...
.button-success:not(:disabled):not(.disabled):active, .btn-success:not(:disabled):not(.disabled).active,
...
.button-success:not(:disabled):not(.disabled):active:focus, .btn-success:not(:disabled):not(.disabled).active:focus,
        ...
        <div class="row">
            <div class="col-12 col-md-5 mx-auto mt-3">
                <form action="<?= site_url('login') ?>" method="POST">
                    ...
                    <div class="form-group">
                        <input type="submit" class="button button-success" value="Login" />
                    </div>
